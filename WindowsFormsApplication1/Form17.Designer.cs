namespace WindowsFormsApplication1
{
    partial class Form17
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataSet171 = new WindowsFormsApplication1.DataSet17();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dataSet171)).BeginInit();
    ...
    "Security Info=True;User ID=lele;Password=Qwerty123";
            ...
            // sqlInsertCommand1
            // 
            this.sqlInsertCommand1.CommandText = "INSERT INTO [Компания] ([Предпр], [Руководит]) VALUES (@Предпр, @Руководит);\r\nSEL" +
    "ECT Предпр, Руководит FROM Компания WHERE (Предпр = @Предпр)";
            ...
            // sqlDeleteCommand1
            // 
            this.sqlDeleteCommand1.CommandText = "DELETE FROM [Компания] WHERE (([Предпр] = @Original_Предпр) AND ((@IsNull_Руковод" +
    "ит = 1 AND [Руководит] IS NULL) OR ([Руководит] = @Original_Руководит)))";
            ...
            // dataSet171
            // 
            this.dataSet171.DataSetName = "DataSet17";
            this.dataSet171.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // label1
            // 
            ...
            // textBox1
            // 
            this.textBox1.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.компанияBindingSource, "Предпр", true));
            ...
            // textBox2
            // 
            this.textBox2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.компанияBindingSource, "Руководит", true));
            ...
            this.компанияBindingSource.DataSource = this.dataSet171;
            // 
            // bindingNavigator1
            // 
            this.bindingNavigator1.AddNewItem = null;
            this.bindingNavigator1.BindingSource = this.компанияBindingSource;
            ...
            this.Сохранить.Size = new System.Drawing.Size(23, 22);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dataSet171)).EndInit();
