...
namespace WindowsFormsApplication1 {
    ...
    public partial class DataSet8 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationКомпания_Покупатели;
        
        private global::System.Data.DataRelation relationПокупатели_Заказы;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationКомпания_Покупатели = this.Relations["Компания_Покупатели"];
            this.relationПокупатели_Заказы = this.Relations["Покупатели_Заказы"];
        }
        ...
        private void InitClass() {
            ...
            this.relationКомпания_Покупатели = new global::System.Data.DataRelation("Компания_Покупатели", new global::System.Data.DataColumn[] {
                        this.tableКомпания.ПредпрColumn}, new global::System.Data.DataColumn[] {
                        this.tableПокупатели.ПредпрColumn}, false);
            this.Relations.Add(this.relationКомпания_Покупатели);
            this.relationПокупатели_Заказы = new global::System.Data.DataRelation("Покупатели_Заказы", new global::System.Data.DataColumn[] {
                        this.tableПокупатели.КодПокупColumn}, new global::System.Data.DataColumn[] {
                        this.tableЗаказы.КодПокупColumn}, false);
            this.Relations.Add(this.relationПокупатели_Заказы);
        }
        ...
        public partial class ЗаказыDataTable : global::System.Data.TypedTableBase<ЗаказыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ЗаказыRow AddЗаказыRow(ПокупателиRow parentПокупателиRowByПокупатели_Заказы, int КодТовара, System.DateTime ДатаЗаказа, int Заказано, System.DateTime ДатаПрод, int Продано) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        ДатаПрод,
                        Продано};
                if ((parentПокупателиRowByПокупатели_Заказы != null)) {
                    columnValuesArray[0] = parentПокупателиRowByПокупатели_Заказы[0];
                }
        ...
        public partial class ПокупателиDataTable : global::System.Data.TypedTableBase<ПокупателиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ПокупателиRow AddПокупателиRow(int КодПокуп, string Фамилия, string Имя, string Отчество, string Телефон, string Индекс, string Страна, string Город, string Область, string Адрес, КомпанияRow parentКомпанияRowByКомпания_Покупатели, bool Кредит) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        null,
                        Кредит};
                if ((parentКомпанияRowByКомпания_Покупатели != null)) {
                    columnValuesArray[10] = parentКомпанияRowByКомпания_Покупатели[0];
                }
        ...
        public partial class ЗаказыRow : global::System.Data.DataRow {
            ...
            public ПокупателиRow ПокупателиRow {
                get {
                    return ((ПокупателиRow)(this.GetParentRow(this.Table.ParentRelations["Покупатели_Заказы"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Покупатели_Заказы"]);
                }
            }
        ...
        public partial class КомпанияRow : global::System.Data.DataRow {
            ...
            public ПокупателиRow[] GetПокупателиRows() {
                if ((this.Table.ChildRelations["Компания_Покупатели"] == null)) {
                    return new ПокупателиRow[0];
                }
                else {
                    return ((ПокупателиRow[])(base.GetChildRows(this.Table.ChildRelations["Компания_Покупатели"])));
                }
            }
        }
        ...
        public partial class ПокупателиRow : global::System.Data.DataRow {
            ...
            public КомпанияRow КомпанияRow {
                get {
                    return ((КомпанияRow)(this.GetParentRow(this.Table.ParentRelations["Компания_Покупатели"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Компания_Покупатели"]);
                }
            }
            ...
            public ЗаказыRow[] GetЗаказыRows() {
                if ((this.Table.ChildRelations["Покупатели_Заказы"] == null)) {
                    return new ЗаказыRow[0];
                }
                else {
                    return ((ЗаказыRow[])(base.GetChildRows(this.Table.ChildRelations["Покупатели_Заказы"])));
                }
            }
        }
